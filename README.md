...
The goal of PortfolioMoments is to ...

Installation
------------

You can install the released version of PortfolioMoments from [CRAN](https://CRAN.R-project.org) with:

``` r
install.packages("PortfolioMoments")
```
